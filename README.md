...
### 右侧传感器板线缆（5-pin JST）⭐ 5V 容忍

| 线色 | STM32引脚 | 本固件用途 | 原始功能 |
|---|---|---|---|
| 🔴 红 | **15V** | 不可用 | 15V 200mA max |
| ⚫ 黑 | **GND** | 公共地 | GND |
| 🔵 蓝 | **PB10** | 档位切换按钮 (→GND) | TX / SCL / PWM1 |
| 🟢 绿 | **PB11** | 前进/倒车开关 (→GND) | RX / SDA / iBUS / PPM / PWM2 |
| 🟡 黄 | - | 未连接 | - |

### SWD 调试接口（4-pin，PCB 焊盘）
...
| **充电检测** | PA12 | 充电器检测 |
| **电池电压采样** | PC2 | 分压检测 |
| **左电机电流** | PA0 / PC3 | Phase A / Phase B |
| **右电机电流** | PC5 / PC4 | Phase C / Phase B |
| **DC母线电流** | PC0 / PC1 | 左/右电机 |
| **霍尔传感器左** | PB5 / PB6 / PB7 | U / V / W |
| **霍尔传感器右** | PB12 / PB13 / PB14 | U / V / W |
